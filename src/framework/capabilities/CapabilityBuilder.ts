...
export class CapabilityBuilder {
  ...
  platformVersion(v: string) { this.caps['appium:platformVersion'] = v; return this }

  /** Device name (e.g. "Pixel_8"). */
  deviceName(v: string) { this.caps['appium:deviceName'] = v; return this }

  /** Device UDID (for physical devices). */
  udid(v: string) { this.caps['appium:udid'] = v; return this }

  /** Device orientation (portrait or landscape). */
  orientation(v: 'PORTRAIT' | 'LANDSCAPE') { this.caps['appium:orientation'] = v; return this }

  /** Language code (ISO format). */
  language(v: string) { this.caps['appium:language'] = v; return this }

  /** Locale code (ISO format). */
  locale(v: string) { this.caps['appium:locale'] = v; return this }

  /** Prevent app reset between sessions. */
  noReset(v = true) { this.caps['appium:noReset'] = v; return this }

  /** Force a full app reset between sessions. */
  fullReset(v = true) { this.caps['appium:fullReset'] = v; return this }

  // ---------- Native app ----------

  /** Path or identifier of the app under test. */
  app(path: string) { this.caps['appium:app'] = path; return this }

  /** iOS bundle identifier. */
  bundleId(v: string) { this.caps['appium:bundleId'] = v; return this }

  /** Android app package name. */
  appPackage(v: string) { this.caps['appium:appPackage'] = v; return this }

  /** Android app activity name. */
  appActivity(v: string) { this.caps['appium:appActivity'] = v; return this }
  ...
  browserName(v: string) { this.caps.browserName = v; return this }

  // ---------- Arbitrary ----------

  /** Add any raw top-level capability key safely. */
  option(k: string, v: unknown) { this.caps[k] = v; return this }

  /** Add any `appium:*` namespaced capability safely. */
  appium(k: string, v: unknown) { this.caps[`appium:${k}`] = v; return this }
  ...
  unset(k: string) { delete this.caps[k]; return this }

  /** Merge/extend with a plain object (e.g., from JSON). */
  merge(obj: Record<string, unknown>) { this.caps = { ...this.caps, ...obj }; return this }
  ...
  build(): Caps { return Object.freeze({ ...this.caps }) }

  /** Mutable clone (useful if a caller must still tweak keys). */
  buildMutable(): Record<string, unknown> { return { ...this.caps } }
}
