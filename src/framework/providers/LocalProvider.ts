...
import { toBuilder, detectPlatformFromCaps, buildCaps } from '../capabilities/_caps'
...
export class LocalProvider implements IDeviceProvider {
  ...
  constructor() {
    ...
    this.appiumHost = (cfg['host'] as string)
    this.appiumPort = (cfg['port'] as number)
    this.appiumPath = (cfg['path'] as string)
  }
